			...
			public void propertyChange(PropertyChangeEvent evt) {
				try {
					if ("date".equals(evt.getPropertyName())){	
						//Se obtienen las fechas formateadas como objetos LocalDate
						...
						if(fechaEntrada != null && fechaSalida != null) {
							double precioReserva = reservaDao.calcularPrecio(fechaEntrada, fechaSalida);
							txtValor.setText("$" + precioReserva);
						}
					}
				}catch(Exception e) {	}		
			}
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {		
					...
					Reserva reserva = reservaController.guardar(fechaEntrada, fechaSalida, precioReserva, formaDePago);
					dispose();
